...
?>
        <p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:','dalux'); ?></label>
        <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></p>
        <p><label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of products to show:','dalux' ); ?></label>
...
register_widget('WP_Widget_Popular_Post_dalux');