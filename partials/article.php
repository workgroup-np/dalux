...
<div id="post-<?php the_ID(); ?>" <?php post_class("post-article");?>>
   	...
   	<div class="tbeer-post-title-metas">
        ...
        <p class="tbeer-news-post-excerpt"><?php echo dalux_the_excerpt_max_charlength(80);?></p>
        ...
        <div class="tbeer-author-commnets-count">
            ...
            <div class="tbeer-comment-view-wrapper">
                ...
                <ul>
                    ...
                    <li class="tbeer-view-counter"><?php echo dalux_getPostViews(get_the_ID()); _e(' Views','dalux');?></li>
